...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', '192.168.100.176', '192.168.178.60']
...
# Media files (User uploaded files - deposit slips, documents, etc.)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Create media directories if they don't exist
os.makedirs(MEDIA_ROOT, exist_ok=True)
os.makedirs(os.path.join(MEDIA_ROOT, 'fees'), exist_ok=True)
...
DEFAULT_FROM_EMAIL = 'Mzuni E-Admission <noreply@mzuni.ac.mw>'
